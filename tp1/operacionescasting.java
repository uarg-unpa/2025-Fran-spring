...
public class operacionescasting {
    public static void main(String[] args) {
        ...
        System.out.printIn("Resultado (valor1 / decimal1) = ") + resultadoDecimal);
        System.out.println("Resultado (valor1 * decimal) = ") + resultadoDecimal);
        System.out.println("Resultado (valor1 * (int) )");
    }
}
